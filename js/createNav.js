    ...
    学习导航: [
      {
        ...
        icon: "./images/favicons/github.png",
        title: "全球开源平台",
      },
      {
        name: "gitee",
        href: "https://gitee.com/",
        icon: "./images/favicons/gitee.ico",
        title: "国内开源平台",
      },
      {
        name: "掘金",
        href: "https://juejin.cn/",
        icon: "./images/favicons/掘金.png",
        title: "编程学习网站",
      },
      {
        name: "csdn",
        href: "https://www.csdn.net/",
        icon: "./images/favicons/csdn.ico",
        title: "编程学习网站",
      },
      {
        name: "知乎",
        href: "https://www.zhihu.com/",
        icon: "./images/favicons/知乎.ico",
        title: "多方面信息网站",
      },
      {
        name: "gitter",
        href: "https://gitter.im/",
        icon: "./images/favicons/gitter.ico",
        title: "聊天平台,可以引入聊天插件到自己的页面中",
      },
      {
        name: "中国知网",
        href: "https://www.cnki.net/",
        icon: "./images/favicons/中国知网.ico",
        title: "查阅文献的网站",
      },
      {
        name: "w3school",
        href: "https://www.w3school.com.cn/",
        icon: "./images/favicons/w3school.png",
        title: "编程学习网站",
      },
      {
        name: "菜鸟教程",
        href: "https://www.runoob.com/",
        icon: "./images/favicons/菜鸟教程.ico",
        title: "编程学习网站",
      },
      {
        name: "stackoverflow",
        href: "https://stackoverflow.com/",
        icon: "./images/favicons/stackoverflow.ico",
        title: "国外编程问题搜索平台",
      },
      {
        name: "MDN",
        href: "https://developer.mozilla.org/zh-CN/",
        icon: "./images/favicons/MDN.png",
        title: "很多相关web开发文档(前端)",
      },
      {
        name: "c语言中文网",
        href: "http://c.biancheng.net/",
        icon: "./images/favicons/c语言中文网.ico",
        title: "编程学习网站",
      },
      {
        name: "印记中文",
        href: "https://docschina.org/",
        icon: "./images/favicons/印记中文.ico",
        title: "编程资源信息网站",
      },
      {
        name: "博客园",
        href: "https://www.cnblogs.com/",
        icon: "./images/favicons/博客园.svg",
        title: "编程学习网站",
      },
      {
        name: "力扣",
        href: "https://leetcode-cn.com/",
        icon: "./images/favicons/力扣.ico",
        title: "算法学习网站",
      },
      {
        name: "简书",
        href: "https://www.jianshu.com/",
        icon: "./images/favicons/简书.ico",
        title: "编程学习网站",
      },
      {
        name: "中文开源社区",
        href: "https://www.oschina.net/",
        icon: "./images/favicons/中文开源社区.ico",
        title: "编程方面的中文开源社区",
      },
      {
        name: "awesome",
    ...
    学习相关软件工具: [
      {
        ...
        icon: "./images/favicons/语雀.png",
        title: "阿里开源的笔记软件",
      },
      {
        name: "幕布",
        href: "https://mubu.com/app",
        icon: "./images/favicons/幕布.ico",
        title: "",
      },
      {
        name: "itellyou",
        href: "https://next.itellyou.cn/",
        icon: "./images/favicons/itellyou.ico",
        title: "各种电脑系统可供下载(重装系统专用)",
      },
      {
        name: "极简插件",
        href: "https://chrome.zzzmh.cn/#/index",
        icon: "./images/favicons/极简插件.ico",
      ...
      },
      {
        ...
        icon: "./images/favicons/NCM格式在线转换.ico",
        title: "音乐格式转换(可以将一些付费音乐的格式转为mp3免费用)",
      },
      {
        name: "fiddler",
        href: "https://www.telerik.com/fiddler",
        icon: "./images/favicons/fiddler.ico",
        title: "网络抓包工具",
      },
      {
        name: "sublime text",
        href: "https://www.sublimetext.com/",
        icon: "./images/favicons/sublime text.ico",
        title: "一款精美的文本编辑器",
      },
      {
        name: "utools",
        href: "http://www.u.tools/",
        icon: "./images/favicons/utools.ico",
        title: "一款电脑软件，集成了很多方便使用的插件",
      },
      {
        name: "ngrok内网穿透",
        href: "https://ngrok.com/",
        icon: "./images/favicons/ngrok内网穿透.svg",
        title: "内网穿透工具",
      },
      {
        name: "花生壳",
        href: "https://hsk.oray.com/",
        icon: "./images/favicons/花生壳.ico",
        title: "内网穿透工具",
      },
      {
        name: "PNG3D",
        href: "https://png3d.com/",
        icon: "./images/favicons/PNG3D.ico",
        title: "将2D图片转换为3D图片",
      },
      {
        name: "AirPortal空传",
        href: "https://airportal.cn/",
        icon: "./images/favicons/AirPortal空传.avif",
        title: "网络文件传输工具",
      },
      {
        name: "视频转gif",
        href: "https://www.toolnb.com/tools/videotogif.html",
        icon: "./images/favicons/视频转gif.ico",
        title: "将视频转为gif格式",
      },
      {
        name: "在线工具",
        href: "https://tool.lu/",
        icon: "./images/favicons/在线工具.ico",
        title: "一大堆花里胡哨的工具",
      },
      {
        name: "多功能图片转换器",
        href: "https://imagestool.com/zh_CN/",
        icon: "./images/favicons/多功能图片转换器.ico",
        title: "图片在线编辑转换器",
      },
      {
        name: "XnSoft",
        href: "https://www.xnview.com/en/xnview/",
        icon: "./images/favicons/XnSoft.ico",
        title: "图片查看工具",
      },
    ],
    网盘存储: [
      {
        ...
        icon: "./images/favicons/百度网盘.ico",
      },
      {
        name: "阿里云盘",
        href: "https://www.aliyundrive.com/",
        icon: "./images/favicons/阿里云盘.ico",
      },
      {
        name: "腾讯微云",
        href: "https://www.weiyun.com/",
        icon: "./images/favicons/腾讯微云.ico",
      },
    ],
    开放平台: [
      {
        ...
        icon: "./images/favicons/腾讯云.ico",
      },
      {
        name: "阿里云",
        href: "https://www.aliyun.com/",
        icon: "./images/favicons/阿里云.ico",
      },
      {
        name: "微信官方文档",
        href: "https://developers.weixin.qq.com/doc/",
        icon: "./images/favicons/微信.ico",
      },
      {
        name: "微信公众平台",
    ...
    求职: [
      {
        ...
        icon: "./images/favicons/牛客网.ico",
        title: "包含很多求职技巧和面试题",
      },
      {
        name: "boss直聘",
        href: "https://www.zhipin.com/",
        icon: "./images/favicons/boss直聘.png",
      },
      {
        name: "天眼查",
        href: "https://www.tianyancha.com/",
        icon: "./images/favicons/天眼查.png",
      },
      {
        name: "企查查",
        href: "https://www.qcc.com/",
        icon: "./images/favicons/企查查.png",
      },
      {
        name: "职友集",
        href: "https://www.jobui.com/",
        icon: "./images/favicons/职友集.ico",
      },
      {
        name: "看准网",
        href: "https://www.kanzhun.com/",
        icon: "./images/favicons/看准网.ico",
      },
    ],
    梯子: [
      {
        ...
        icon: "./images/favicons/sms-activat.png",
        title: "虚拟电话号码购买",
      },
      {
        name: "斗罗云",
        href: "https://www.douluoyun.lol/",
        icon: "./images/favicons/斗罗云.ico",
      },
      {
        name: "桔子云",
      ...
      },
      {
        ...
        icon: "./images/favicons/STC-SERVER.ico",
      },
    ],
    外包接单: [
      {
        ...
        icon: "./images/favicons/码市.ico",
      },
      {
        name: "开源众包",
        href: "https://zb.oschina.net/",
        icon: "./images/favicons/开源众包.ico",
      },
      {
        name: "程序猿客栈",
        href: "https://www.proginn.com/",
        icon: "./images/favicons/程序猿客栈.ico",
      },
      {
        name: "猪八戒",
        href: "https://honghe.zbj.com/",
        icon: "./images/favicons/猪八戒.ico",
      },
      {
        name: "英选",
        href: "https://www.yingxuan.io/",
        icon: "./images/favicons/英选.ico",
      },
      {
        name: "开发邦",
        href: "https://www.kaifabang.com/",
        icon: "./images/favicons/开发邦.ico",
      },
      {
        name: "猿急送",
        href: "https://www.yuanjisong.com/",
        icon: "./images/favicons/猿急送.ico",
      },
      {
        name: "人人开发",
        href: "http://rrkf.com/",
        icon: "./images/favicons/人人开发.png",
      },
    ],
    "3d引擎": [
      {
        ...
        icon: "./images/favicons/unity.ico",
      },
      {
        name: "虚幻4引擎",
        href: "https://www.unrealengine.com/zh-CN/",
        icon: "./images/favicons/虚幻4引擎.png",
      },
    ],
    开源插件项目: [
      {
  ...
  web3: {
    资料: [
      ...
      },
      {
        ...
        icon: "./images/favicons/metamask.png",
        title: "以太币钱包工具",
      },
      {
        name: "Remix",
        href: "https://remix.ethereum.org/",
        icon: "./images/favicons/Remix.webp",
        title: "在线开发智能合约",
      },
      {
        name: "dapp university",
        href: "https://www.dappuniversity.com/",
        icon: "./images/favicons/dapp university.png",
      },
      {
        name: "登链社区",
        href: "https://learnblockchain.cn/",
        icon: "./images/favicons/登链社区.png",
      },
      {
        name: "区块链技术博客",
      ...
      },
      {
        ...
        icon: "./images/favicons/truffle.png",
      },
      {
        name: "truffle",
    ...
    应用: [
      {
        ...
        title: "一款基于以太币的货品",
        icon: "./images/favicons/谜恋猫.ico",
      },
      {
        name: "欧易",
        href: "https://www.lybg1688.com/",
        title: "去中心化交易平台",
        icon: "./images/favicons/欧易.png",
      },
      {
        name: "filescan",
        href: "https://www.filescan.io/scan",
        title: "分布式文件存储网站",
        icon: "./images/favicons/filescan.avif",
      },
      {
        name: "IPFS",
        href: "https://ipfs.tech/",
        title: "星际邮件系统官网",
        icon: "./images/favicons/IPFS.ico",
      },
      {
        name: "上海数据交易所",
        href: "https://www.chinadep.com/",
        title: "上海数据交易所",
        icon: "./images/favicons/上海数据交易所.ico",
      },
      {
        name: "星火链网",
        href: "https://bitfactory.cn/",
        title: "星火链网",
        icon: "./images/favicons/星火链网.ico",
      },
    ],
  },
  AI: {
    "stable diffusion 专栏": [
      {
        ...
        title: "ai模型",
        icon: "./images/favicons/civitai.ico",
      },
      {
        name: "openart",
        href: "https://openart.ai/",
        title: "ai模型",
        icon: "./images/favicons/openart.ico",
      },
      {
        name: "arthub",
        href: "https://arthub.ai/",
        title: "ai模型",
        icon: "./images/favicons/arthub.ico",
      },
      {
        name: "dawnmark",
        href: "https://ai.dawnmark.cn/",
        title: "ai词汇",
        icon: "./images/favicons/dawnmark.ico",
      },
      {
        name: "atoolbox",
        href: "http://www.atoolbox.net/Tool.php?Id=1101",
        title: "ai词汇",
        icon: "./images/favicons/atoolbox.ico",
      },
    ],
    应用: [
      {
        ...
        title: "",
        icon: "./images/favicons/openai.ico",
      },
      {
        name: "chatgpt",
        href: "https://chat.openai.com/",
        title: "",
        icon: "./images/favicons/chatgpt.png",
      },
      {
        name: "phind",
        href: "https://www.phind.com/",
        title: "编程搜索引擎",
        icon: "./images/favicons/phind.png",
      },
      {
        name: "leiapix",
        href: "https://convert.leiapix.com/",
        title: "图片转深度图",
        icon: "./images/favicons/leiapix.ico",
      },
      {
        name: "AIAS-AI",
        href: "http://aias.top/",
        title: "一些算法代码",
        icon: "./images/favicons/AIAS-AI.ico",
      },
    ],
  },
  前端开发: {
    Vue相关: [
      {
        ...
        icon: "./images/favicons/vue.svg",
      },
      {
        name: "VueUse",
        href: "https://vueuse.org/",
        icon: "./images/favicons/VueUse.png",
      },
      {
        name: "vue2",
      ...
      },
      {
        ...
        icon: "./images/favicons/ElementUI.ico",
        title: "饿了么开发的组件库，支持vue2",
      },
      {
        name: "Element Plus",
        href: "https://element-plus.gitee.io/zh-CN/",
        icon: "./images/favicons/Element Plus.svg",
        title: "饿了么开发的组件库，支持vue3",
      },
      {
        name: "pinia",
        href: "https://pinia.vuejs.org/",
        icon: "./images/favicons/pinia.svg",
        title: "状态管理工具，比较适用vue3，可以替代vuex使用",
      },
      {
        name: "nuxt2",
        href: "https://v2.nuxt.com/",
        icon: "./images/favicons/nuxt.svg",
        title: "基于vue的ssr框架",
      },
      {
        name: "nuxt3",
      ...
      },
      {
        ...
        icon: "./images/favicons/vue-element-admin.ico",
      ...
      },
      {
        ...
        icon: "./images/favicons/vue-aplayer.ico",
        title: "开源的音乐播放器插件",
      },
      {
      ...
      },
      {
        ...
        icon: "./images/favicons/Vant.png",
        title: "轻量的移动端vue组件库",
      },
      {
        name: "NutUI",
        href: "https://nutui.jd.com/#/",
        icon: "./images/favicons/NutUI.avif",
        title: "京东风格的轻量级移动端 Vue 组件库",
      },
      {
        name: "dcloud",
        href: "https://www.dcloud.io/",
        icon: "./images/favicons/dcloud.png",
      ...
      },
      {
        ...
        icon: "./images/favicons/fantastic-admin.ico",
        title: "vue3的开源后台管理系统模板",
      },
      {
        name: "arco design",
        href: "https://arco.design/",
        icon: "./images/favicons/arco design.ico",
        title: "字节开源后台管理系统模板",
      },
      {
        name: "Geeker-Admin",
      ...
      },
      {
        ...
        icon: "./images/favicons/Vuetify.ico",
        title: "Vuetify",
      },
      {
        name: "mini-vue",
    ...
    构建打包工具: [
      {
        ...
        icon: "./images/favicons/Vite.svg",
        title: "前端构建工具,比较适合vue3",
      },
      {
        name: "Webpack",
        href: "https://webpack.docschina.org/",
        icon: "./images/favicons/Webpack.ico",
        title: "前端打包构建工具",
      },
      {
        name: "rollup",
        href: "https://rollupjs.org/",
        icon: "./images/favicons/rollup.png",
        title: "前端构建工具",
      },
    ],
    React相关: [
      {
        ...
        icon: "./images/favicons/react.ico ",
      },
      {
        name: "Ant Design",
        href: "https://ant.design/docs/react/introduce-cn",
        icon: "./images/favicons/Ant Design.avif",
    ...
    其他js框架类库: [
      {
        ...
        icon: "./images/favicons/typescript.png",
        title: "js语法增强版",
      },
      {
        name: "lodash",
        href: "https://www.lodashjs.com/",
        icon: "./images/favicons/lodash.ico",
      ...
      },
      {
        ...
        icon: "./images/favicons/UmiJS.svg",
        title: "多功能的前端框架，详情看官网",
      },
      {
        name: "Day.js",
        href: "https://day.js.org/zh-CN/",
        icon: "./images/favicons/Dayjs.avif",
        title: "js时间日期处理库",
      },
      {
        name: "momentjs",
        href: "http://momentjs.cn/",
        icon: "./images/favicons/momentjs.png",
        title: "js时间日期处理库",
      },
      {
        name: "date-fns",
        href: "https://date-fns.org/",
        icon: "./images/favicons/date-fns.png",
        title: "js时间日期处理库",
      },
      {
        name: "Velocity",
        href: "http://www.5imoban.net/view/Velocity/vuejs.html",
        icon: "./images/favicons/Velocity.ico",
    ...
    css: [
      {
        ...
        icon: "./images/favicons/CSS-TRICKS.ico",
        title: "国外CSS学习网站",
      },
      {
        name: "iCSS",
      ...
      },
      {
        ...
        icon: "./images/favicons/less.ico",
        title: "css增强语法",
      },
      {
        name: "stylus",
        href: "https://www.stylus-lang.cn/",
        icon: "./images/favicons/stylus.ico",
        title: "css增强语法",
      },
      {
        name: "sass",
        href: "https://www.sass.hk/",
        icon: "./images/favicons/sass.ico",
        title: "css增强语法",
      },
      {
        name: "tailwindcss",
        href: "https://www.tailwindcss.cn/",
        icon: "./images/favicons/tailwindcss.png",
        title: "精美css语法库,可以通过简化css语句操作html并有更美观的效果",
      },
      {
        name: "Windi CSS",
        href: "https://windicss.org/",
        icon: "./images/favicons/Windi CSS.svg",
        title: "精美css语法库,可以通过简化css语句操作html并有更美观的效果",
      },
      {
        name: "AnimateCss",
        href: "https://animate.style/",
        icon: "./images/favicons/AnimateCss.ico",
        title: "简单css动画库",
      },
      {
        name: "css-doodle",
        href: "https://css-doodle.com/",
        icon: "./images/favicons/css-doodle.png",
        title: "css粒子特效组件",
      },
      {
        name: "css练习",
      ...
      },
      {
        ...
        icon: "./images/favicons/postcss.ico",
    ...
    图表: [
      {
        ...
        icon: "./images/favicons/Echarts.png",
        title: "我比较常用的图表库",
      },
      {
        name: "DataV",
        href: "http://datav.jiaminghi.com/",
        icon: "./images/favicons/DataV.ico",
      },
      {
        name: "AntV",
        href: "https://antv.vision/zh",
        icon: "./images/favicons/AntV.avif",
      },
      {
        name: "inMap",
        href: "http://inmap.talkingdata.com/#/index",
        icon: "./images/favicons/inMap.ico",
      },
      {
        name: "d3",
    ...
    微前端: [
      {
        ...
        icon: "./images/favicons/single-spa.ico",
        title: "比较传统的微前端解决方案",
      },
      {
        name: "qiankun",
        href: "https://qiankun.umijs.org/zh",
        icon: "./images/favicons/qiankun.png",
        title: "比较全面的微前端解决方案",
      },
      {
        name: "micro-app",
        href: "https://micro-zoe.github.io/micro-app/",
        icon: "./images/favicons/micro-app.ico",
        title: "微前端解决方案",
      },
    ],
    "3D": [
      {
        ...
        icon: "./images/favicons/webgl中文网.ico",
        title: "用于web3D",
      },
      {
        name: "Three.js",
        href: "http://www.webgl3d.cn/",
        icon: "./images/favicons/Three.js.ico",
        title: "3d框架",
      },
      {
        name: "CesiumGS",
    ...
    移动端: [
      {
        ...
        icon: "./images/favicons/uView UI.avif",
        title:
      ...
      },
      {
        ...
        icon: "./images/favicons/Frozen.ico",
        title: "移动端ui组件库",
      },
    ],
    一些插件: [
      {
        ...
        icon: "./images/favicons/vscode插件.ico",
        title: "vscode插件",
      },
      {
        name: "nprogress",
        href: "https://madewith.cn/23",
        icon: "./images/favicons/nprogress.avif",
        title: "加载进度条",
      },
      {
        name: "plupload文件上传插件",
        href: "https://www.plupload.com/",
        icon: "./images/favicons/plupload文件上传插件.ico",
        title: "文件上传插件",
      },
      {
        name: "Aplayer",
      ...
      },
      {
        ...
        icon: "./images/favicons/swiper.ico",
        title: "轮播图插件",
      },
      {
        name: "Aliplayer",
        href: "https://player.alicdn.com/aliplayer/index.html",
        icon: "./images/favicons/Aliplayer.ico",
        title: "视频播放插件",
      },
      {
        name: "西瓜播放器",
        href: "https://v2.h5player.bytedance.com/",
        icon: "./images/favicons/西瓜播放器.ico",
        title: "视频播放插件",
      },
      {
        name: "editormd",
        href: "https://pandao.github.io/editor.md/",
        icon: "./images/favicons/editormd.ico",
        title: "富文本编辑器插件",
      },
      {
        name: "tinymce富文本编辑器",
      ...
      },
      {
        ...
        icon: "./images/favicons/Quill富文本编辑器.ico",
        title: "富文本编辑器插件",
      },
      {
        name: "froala富文本编辑器",
        href: "https://froala.com/wysiwyg-editor/",
        icon: "./images/favicons/froala富文本编辑器.png",
        title: "比较美观的一款富文本编辑器插件",
      },
      {
        name: "ckeditor富文本编辑器",
        href: "https://ckeditor.com/",
        icon: "./images/favicons/ckeditor富文本编辑器.png",
        title: "富文本编辑器插件",
      },
      {
        name: "tiptap富文本编辑器",
        href: "https://tiptap.dev/",
        icon: "./images/favicons/tiptap富文本编辑器.svg",
        title: "富文本编辑器插件",
      },
      {
        name: "qs",
      ...
      },
      {
        ...
        icon: "./images/favicons/fabric.ico",
        title: "基于canvas的库，简化2D操作",
      },
      {
        name: "wowjs",
        href: "https://wowjs.uk/",
        icon: "./images/favicons/wowjs.ico",
        title: "滚动加载特效插件",
      },
      {
        name: "particles",
    ...
    UI设计灵感: [
      {
        ...
        icon: "./images/favicons/Behance.ico",
        title: "全球最大的综合性设计网站之一",
      },
      {
        name: "UICN用户体验设计平台",
        href: "https://www.ui.cn/",
        icon: "./images/favicons/UICN用户体验设计平台.ico",
        title: "国内最大UI设计交流平台之一",
      },
      {
        name: "dribbble",
        href: "https://dribbble.com/pachytel",
        icon: "./images/favicons/dribbble.ico",
        title: "非常不错的一个UI平台，就是国外的有点慢",
      },
      {
        name: "81-web",
        href: "https://81-web.com/",
        icon: "./images/favicons/81-web.ico",
        title: "一款日本的webUI设计平台",
      },
      {
        name: "muuuuu",
        href: "https://muuuuu.org/",
        icon: "./images/favicons/muuuuu.ico",
        title: "一款日本的webUI设计平台",
      },
      {
        name: "webdesignclip",
        href: "https://webdesignclip.com/",
        icon: "./images/favicons/webdesignclip.ico",
        title: "日本酷站画廊",
      },
      {
        name: "Awwwards",
        href: "http://bm.straightline.jp/",
        icon: "./images/favicons/Awwwards.ico",
        title: "最佳网页设计趋势（日本平台）",
      },
      {
        name: "Reeoo",
        href: "https://reeoo.com/",
        icon: "./images/favicons/Reeoo.ico",
        title: "网页设计灵感和网站画廊",
      },
      {
        name: "SiteSee ",
        href: "https://sitesee.co/",
        icon: "./images/favicons/SiteSee.ico",
        title: "收录漂亮的界面设计网站",
      },
    ],
    素材: [
      {
        ...
        icon: "./images/favicons/阿里巴巴矢量图标库.svg",
        title: "我心中最好的字体图标网站",
      },
      {
        name: "Icônes",
        href: "https://icones.js.org/",
        icon: "./images/favicons/Icônes.svg",
        title: "免费图标、logo",
      },
      {
        name: "Icon Sets • Iconify",
        href: "https://icon-sets.iconify.design/",
        icon: "./images/favicons/Iconify.png",
        title: "免费图标、logo",
      },
      {
        name: "dafont",
        href: "https://www.dafont.com/",
        icon: "./images/favicons/dafont.ico",
        title: "免费字体",
      },
      {
        name: "webfont-generator",
        href: "https://www.fontsquirrel.com/tools/webfont-generator",
        icon: "./images/favicons/webfont-generator.png",
        title: "将ttf字体转为其他html可用的字体",
      },
      {
        name: "Font Awesome",
        href: "http://www.fontawesome.com.cn/",
        icon: "./images/favicons/Font Awesome.ico",
        title: "mavoneditor用的这一款,比较不错",
      },
      {
        name: "heroicons",
        href: "https://heroicons.com/",
        icon: "./images/favicons/heroicons.png",
        title: "一款字体图标库",
      },
      {
        name: "fontspace",
        href: "https://www.fontspace.com/",
        icon: "./images/favicons/fontspace字体.webp",
        title: "一款字体图标库",
      },
      {
        name: "undraw",
        href: "https://undraw.co/illustrations",
        icon: "./images/favicons/undraw.ico",
      ...
      },
      {
        ...
        icon: "./images/favicons/花瓣网.png",
        title: "素材及UI设计网站",
      },
      {
        name: "平面设计师素材网",
        href: "https://www.1001freedownloads.com/",
        icon: "./images/favicons/平面设计师素材网.ico",
      },
      {
        name: "懒人包PNG素材网",
        href: "https://www.stickpng.com/",
        icon: "./images/favicons/懒人包PNG素材网.ico",
      },
      {
        name: "免费商用高清图库",
        href: "https://unsplash.com/",
        icon: "./images/favicons/免费商用高清图库.png",
      },
      {
        name: "免费商用PSD设计图",
        href: "https://www.freepik.com/",
        icon: "./images/favicons/免费商用PSD设计图.ico",
      },
      {
        name: "日本免费矢量图库网",
        href: "https://event-pre.com/",
        icon: "./images/favicons/日本免费矢量图库网.ico",
      },
      {
        name: "PNG透明素材网",
        href: "https://www.cleanpng.com/",
        icon: "./images/favicons/PNG透明素材网.ico",
      },
    ],
    图片处理: [
      {
      ...
      },
      {
        ...
        icon: "./images/favicons/carbon生成图片.ico",
        title: "可以生成代码背景的图片",
      },
      {
        name: "在线PS",
        href: "https://www.gaituya.com/ps/",
        icon: "./images/favicons/在线PS.ico",
      },
      {
        name: "智能抠图",
        href: "https://www.isheji.com/cutout/workbench?img_id=60c9b7284a9a3",
        icon: "./images/favicons/智能抠图.ico",
      },
      {
        name: "智能抠图网站",
        href: "https://www.remove.bg/zh",
        icon: "./images/favicons/智能抠图网站.png",
      },
      {
        name: "tinypng",
        href: "https://tinypng.com/",
        title: "图片压缩网站",
        icon: "./images/favicons/tinypng.ico",
      },
      {
        name: "convert2svg",
        href: "https://convert2svg.com/",
        title: "图片转为svg格式",
        icon: "./images/favicons/convert2svg.ico",
      },
      {
        name: "慕客",
        href: "https://www.mockplus.cn/",
        title: "快速制作ui原型图",
        icon: "./images/favicons/慕客.ico",
      },
    ],
    字体: [
      {
        ...
        icon: "./images/favicons/100font.ico",
        title: "免费商用字体",
      },
      {
        name: "站长字体",
        href: "https://font.chinaz.com/",
        icon: "./images/favicons/站长字体.ico",
        title: "免费字体",
      },
      {
        name: "fontmin",
        href: "http://ecomfe.github.io/fontmin/#source",
        icon: "./images/favicons/fontmin.ico",
        title: "字体集成压缩",
      },
      {
        name: "transfonter",
        href: "https://transfonter.org/#",
        icon: "./images/favicons/transfonter.ico",
        title: "字体工具(暂时没研究功能)",
      },
    ],
    取色: [
      {
        ...
        icon: "./images/favicons/ColorSpace.png",
        title: "调色板",
      },
      {
        name: "gradihunt",
        href: "https://gradihunt.com/",
        icon: "./images/favicons/gradihunt.avif",
        title: "渐变色",
      },
      {
        name: "gradients",
        href: "https://webgradients.com/?ref=iamxk",
        icon: "./images/favicons/gradients.avif",
        title: "渐变色",
      },
      {
        name: "grabient",
        href: "https://www.grabient.com/",
        icon: "./images/favicons/grabient.ico",
        title: "渐变色",
      },
      {
        name: "html取色器",
        href: "https://c.runoob.com/front-end/5449/",
        icon: "./images/favicons/html取色器.ico",
        title: "菜鸟工具里的取色器",
      },
      {
        name: "中国色",
        href: "http://zhongguose.com/",
        icon: "./images/favicons/中国色.ico",
        title: "中国传统颜色取色",
      },
      {
        name: "Color Hunt",
        href: "https://www.colorhunt.co/",
        icon: "./images/favicons/Color Hunt.svg",
        title: "一款不错的颜色搭配取色",
      },
      {
        name: "Adobe Color",
        href: "https://color.adobe.com/zh/create/color-wheel",
        icon: "./images/favicons/Adobe Color.ico",
        title: "权威的色彩网站之一",
      },
      {
        name: "WEBSAFECOLORS",
    ...
    代码生成的一些样式: [
      {
        ...
        icon: "./images/favicons/Variant Form.ico",
        title: "地代码表单生成平台",
      },
      {
        name: "CodeFun",
        href: "https://code.fun/",
        icon: "./images/favicons/CodeFun.ico",
        title: "代码生成平台，外包神器",
      },
      {
        name: "creative-backgrounds",
        href: "https://wweb.dev/resources/creative-backgrounds/",
        icon: "./images/favicons/wweb.ico",
        title: "文案背景",
      },
      {
        name: "getwaves",
        href: "https://getwaves.io/",
        icon: "./images/favicons/getwaves.png",
        title: "获取波浪效果的svg",
      },
      {
      ...
      },
      {
        ...
        icon: "./images/favicons/fancy-border-radius.png",
        title: "特殊圆角",
      },
      {
        name: "navnav",
        href: "http://navnav.co/",
        icon: "./images/favicons/navnav.png",
        title: "各种特效现成的代码",
      },
      {
        name: "hype4",
        href: "https://hype4.academy/tools",
        icon: "./images/favicons/hype4.png",
        title: "包含css卡片生成器等",
      },
    ],
    杂项: [
      ...
      },
      {
        ...
        icon: "./images/favicons/pyscript.ico",
    ...
    工具: [
      {
        ...
        icon: "./images/favicons/Bitbucket.avif",
        title: "私有仓库管理工具",
      },
      {
        name: "docker",
        href: "https://www.docker.com/",
        icon: "./images/favicons/docker.webp",
        title: "",
      },
      {
        name: "docker版本",
        href: "https://docs.docker.com/desktop/release-notes/#442",
        icon: "./images/favicons/docker版本.ico",
        title: "下载不同版本docker",
      },
      {
        name: "jsonplaceholder",
        href: "http://jsonplaceholder.typicode.com/",
        icon: "./images/favicons/jsonplaceholder.ico",
        title: "JSON解析",
      },
    ],
    接口测试工具: [
      {
        ...
        icon: "./images/favicons/apipost.ico",
        title: "国人开发的接口测试工具，支持接口在线查看",
      },
      {
        name: "Apifox",
        href: "https://www.apifox.cn/",
        icon: "./images/favicons/Apifox.avif",
        title: "主要用于前端mock数据",
      },
      {
        name: "postman",
        href: "https://www.postman.com/",
        icon: "./images/favicons/postman.png",
        title: "主要用于测试后端接口",
      },
    ],
    python: [
      {
        ...
        icon: "./images/favicons/flask.webp",
    ...
    node: [
      {
        name: "nodejs",
        href: "http://nodejs.cn/",
        icon: "./images/favicons/nodejs.png",
        title: "nodejs官网",
      },
      {
        name: "CNode",
        href: "https://cnodejs.org/",
        icon: "./images/favicons/CNode.png",
        title: "nodejs中文社区",
      },
      {
        name: "NestJS",
        href: "https://nestjs.bootcss.com/",
        icon: "./images/favicons/NestJS.ico",
        title: "支持ts的node框架",
      },
      {
        name: "helmet",
    ...
    java: [
      {
        ...
        icon: "./images/favicons/springboot.png",
      },
      {
        name: "maven",
        href: "https://maven.apache.org/",
        icon: "./images/favicons/maven.ico",
        title: "java依赖管理的工具",
      },
      {
        name: "mvnrepository",
        href: "https://mvnrepository.com/",
        icon: "./images/favicons/mvnrepository.ico",
      ...
      },
      {
        ...
        icon: "./images/favicons/mybatis-plus.ico",
        title: "mybatis的升级版",
      },
      {
        name: "ruoyi",
        href: "http://www.ruoyi.vip/",
        icon: "./images/favicons/ruoyi.ico",
    ...
    导航站点: [
      {
        ...
        icon: "./images/favicons/兰客书签.png",
      },
      {
        name: "ABOUT导航",
        href: "https://www.aboutppt.com/",
        icon: "./images/favicons/ABOUT导航.ico",
      },
      {
        name: "阿雷资源导航",
        href: "http://aleikeji.com/",
        icon: "./images/favicons/阿雷资源导航.ico",
      },
    ],
    图片: [
      {
        ...
        icon: "./images/favicons/pixiv.ico",
      },
      {
        name: "wallhaven",
        href: "https://wallhaven.cc/",
        icon: "./images/favicons/wallhaven.ico",
      },
      {
        name: "壁纸深渊",
        href: "https://wall.alphacoders.com/",
        icon: "./images/favicons/壁纸深渊.png",
      },
      {
        name: "极简壁纸",
        href: "https://bz.zzzmh.cn/index",
        icon: "./images/favicons/极简壁纸.png",
      },
      { name: "Takagi画廊", href: "https://view.lixingyong.com/", icon: "" },
      {
        name: "Pexels",
        href: "https://www.pexels.com/zh-cn/",
        icon: "./images/favicons/Pexels.ico",
        title: "摄影图片视频资源",
      },
      {
        name: "pixabay",
        href: "https://pixabay.com/zh/",
        icon: "./images/favicons/pixabay.png",
        title: "免费正版高清图片",
      },
      {
        name: "wallpaperscraft",
        href: "https://wallpaperscraft.com/",
        icon: "./images/favicons/wallpaperscraft.ico",
        title: "图片资源",
      },
      {
        name: "wallpapermaiden",
        href: "https://www.wallpapermaiden.com/",
        icon: "./images/favicons/wallpapermaiden.png",
        title: "图片资源",
      },
      {
        name: "anime-pictures",
        href: "https://anime-pictures.net/",
        icon: "./images/favicons/anime-pictures.ico",
        title: "图片资源",
      },
      {
        name: "wallroom",
        href: "https://wallroom.io/",
        icon: "./images/favicons/wallroom.ico",
        title: "图片资源",
      },
      {
        name: "iLikeWallpaper",
        href: "https://www.ilikewallpaper.net/",
        icon: "./images/favicons/iLikeWallpaper.png",
        title: "图片资源",
      },
    ],
    动漫视频: [
      {
        ...
        icon: "./images/favicons/蜜柑计划.ico",
      },
      {
        name: "动漫花园",
        href: "https://dmhy.org/",
        icon: "./images/favicons/动漫花园.ico",
      },
      {
        name: "致美化",
        href: "https://zhutix.com/",
        icon: "./images/favicons/致美化.avif",
      },
      {
        name: "潮点视频",
        href: "https://shipin520.com/",
        icon: "./images/favicons/潮点视频.ico",
      },
    ],
    音乐: [
      {
        ...
        icon: "./images/favicons/MyFreeMP3.ico",
      },
    ],
  },
  娱乐: {
    购物: [
      {
        ...
        icon: "./images/favicons/全球付.ico",
      },
      {
        name: "PingPong Joy",
        href: "https://joy.pingpongx.com/index",
        icon: "./images/favicons/PingPong Joy.ico",
      },
      {
        name: "淘宝",
        href: "https://www.taobao.com/",
        icon: "./images/favicons/淘宝.png",
      },
      {
        name: "天猫",
        href: "https://www.tmall.com/",
        icon: "./images/favicons/天猫.png",
      },
      {
        name: "京东",
        href: "https://www.jd.com/",
        icon: "./images/favicons/京东.ico",
      },
    ],
    动漫: [
      {
        ...
        icon: "./images/favicons/兜兜动漫.png",
      },
      {
        name: "酷酷兔",
        href: "http://kukutu8.com/",
        icon: "./images/favicons/酷酷兔.ico",
      },
      {
        name: "ppxdm",
        href: "http://www.ppxdm.com/index.php",
        icon: "./images/favicons/ppxdm.ico",
      },
    ],
    影视: [
      {
        ...
        icon: "./images/favicons/豆瓣.ico",
      },
      {
        name: "youtube",
        href: "https://www.youtube.com/",
        icon: "./images/favicons/youtube.ico",
      },
      {
        name: "奈非",
        href: "https://www.netflix.com/browse",
        icon: "./images/favicons/奈非.ico",
      },
      {
        name: "cctv片库",
        href: "https://tv.cctv.com/yxg/index.shtml#datacid=dsj&datafl=&datadq=&fc=%E7%94%B5%E8%A7%86%E5%89%A7&datanf=&dataszm=",
        icon: "./images/favicons/cctv片库.ico",
      },
      {
        name: "腾讯视频",
        href: "https://v.qq.com/",
        icon: "./images/favicons/腾讯视频.ico",
      },
      {
        name: "爱奇艺",
        href: "https://www.iqiyi.com/",
        icon: "./images/favicons/爱奇艺.avif",
      },
      {
        name: "低端影视",
        href: "https://ddys.tv/",
        icon: "./images/favicons/低端影视.png",
      },
    ],
    漫画: [
      {
        ...
        icon: "./images/favicons/古风漫画网.ico",
      },
      {
        name: "动漫屋",
        href: "https://www.dm5.com/",
        icon: "./images/favicons/动漫屋.ico",
      },
      {
        name: "漫客栈",
        href: "https://www.mkzhan.com/",
        icon: "./images/favicons/漫客栈.ico",
      },
    ],
    小说: [
      { name: "读书导航", href: "http://www.zoudupai.com/", icon: "" },
      {
        ...
        icon: "./images/favicons/笔趣阁.ico",
      },
      {
        name: "笔下文学",
        href: "https://www.94bxwx.com/",
        icon: "./images/favicons/笔下文学.ico",
      },
      {
        name: "乐阅读",
        href: "https://www.27k.net/",
        icon: "./images/favicons/乐阅读.ico",
      },
    ],
    游戏: [
      {
        ...
        icon: "./images/favicons/steam.ico",
      },
      {
        name: "NGA玩家社区",
        href: "https://bbs.nga.cn/",
        icon: "./images/favicons/NGA玩家社区.ico",
      },
      {
        name: "灰机wiki",
        href: "https://www.huijiwiki.com/",
        icon: "./images/favicons/灰机wiki.png",
      },
      {
        name: "心悦俱乐部",
        href: "https://xinyue.qq.com/beta/#/",
        icon: "./images/favicons/心悦俱乐部.ico",
      },
      {
        name: "开黑啦",
        href: "https://www.kaiheila.cn/",
        icon: "./images/favicons/开黑啦.ico",
      },
    ],
    ff14专题: [
      {
      ...
      },
      {
        ...
        icon: "./images/favicons/中文wiki.avif",
      },
      {
        name: "素素",
        href: "http://www.ffxiv.cn/v2/",
        icon: "./images/favicons/素素.ico",
      },
      {
        name: "光之收藏家",
        href: "https://www.ffxivsc.cn/#/",
        icon: "./images/favicons/光之收藏家.png",
      },
      {
        name: "飞艇坪",
        href: "https://www.ffxiv.co/",
        icon: "./images/favicons/飞艇坪.ico",
      },
      {
        name: "狩猎发车",
        href: "https://ffxivhuntcn.com/#/train/index",
        icon: "./images/favicons/狩猎发车.ico",
      },
      {
        name: "nga",
      ...
      },
      {
        ...
        icon: "./images/favicons/优雷卡触发.png",
      },
    ],
    杂项: [
      {
        ...
        icon: "./images/favicons/冷笑话.png",
      },
      {
        name: "每日一文",
        href: "https://meiriyiwen.com/",
        icon: "./images/favicons/每日一文.ico",
      },
      {
        name: "MBTI测试",
        ...
        icon: "./images/favicons/MBTI测试.ico",
      },
      {
        name: "996ICU",
    ...
    开源博客框架: [
      {
        ...
        icon: "./images/favicons/hexo.png",
      },
      {
        name: "halo",
        href: "https://halo.run/",
        icon: "./images/favicons/halo.webp",
      },
    ],
    大佬博客: [
      {
        ...
        icon: "./images/favicons/阮一峰的个人网站.ico",
      },
      {
        name: "CSS-Inspiration",
        href: "https://chokcoco.github.io/CSS-Inspiration/#/",
        icon: "./images/favicons/CSS-Inspiration.avif",
        title: "css灵感博客",
      },
      {
        name: "程序员成长指北",
        href: "http://www.inode.club/",
        icon: "./images/favicons/程序员成长指北.ico",
      },
      {
        name: "大场面试每日一题",
        href: "https://q.shanyue.tech/",
        icon: "./images/favicons/大场面试每日一题.ico",
      },
      {
        name: "峰华前端工程师",
        href: "https://zxuqian.cn/",
        icon: "./images/favicons/峰华前端工程师.ico",
      },
      { name: "aiiyx", href: "https://aiiyx.cn/", icon: "" },
      {
        name: "楠格",
        href: "https://www.nange.cn/",
        icon: "./images/favicons/楠格.png",
      },
      {
        name: "Amaya丶夜雨",
        href: "https://amayaliu.cn/",
        icon: "./images/favicons/Amaya丶夜雨.avif",
      },

...
const navList = {
  ...
  "前端开发": {
    ...
    "css": [
      ...
      {name: 'tailwindcss', href: 'https://www.tailwindcss.cn/', icon: './images/favicons/tailwindcss.png', title: '精美css语法库,可以通过简化css语句操作html并有更美观的效果'},
      {name: 'Windi CSS', href: 'https://windicss.org/', icon: './images/favicons/Windi CSS.svg', title: '精美css语法库,可以通过简化css语句操作html并有更美观的效果'},
      {name: 'AnimateCss', href: 'https://animate.style/', icon: './images/favicons/AnimateCss.ico', title: '简单css动画库'},
      {name: 'css-doodle', href: 'https://css-doodle.com/', icon: './images/favicons/css-doodle.png', title: 'css粒子特效组件'},
      ...
      {name: 'postcss', href: 'https://postcss.org/', icon: './images/favicons/postcss.ico', title: '通过js配置css(我只在vue脚手架中见过)'},
      {name: 'greensock', href: 'https://github.com/greensock/GSAP', icon: './images/favicons/github.png', title: 'js控制的css动画库'},
    ],
    "图表": [
      {name: 'Echarts', href: 'https://echarts.apache.org/zh/index.html', icon: './images/favicons/Echarts.png', title: '我比较常用的图表库'},
      {name: 'DataV', href: 'http://datav.jiaminghi.com/', icon: './images/favicons/DataV.ico'},
      {name: 'AntV', href: 'https://antv.vision/zh', icon: './images/favicons/AntV.png'},
      {name: 'inMap', href: 'http://inmap.talkingdata.com/#/index', icon: './images/favicons/inMap.ico'},
      {name: 'd3', href: 'https://github.com/d3/d3', icon: './images/favicons/github.png', title: '图表库'},
    ],
    "微前端": [
      {name: 'single-spa', href: 'https://zh-hans.single-spa.js.org/', icon: './images/favicons/single-spa.ico', title: '比较传统的微前端解决方案'},
      {name: 'qiankun', href: 'https://qiankun.umijs.org/zh', icon: './images/favicons/qiankun.png', title: '比较全面的微前端解决方案'},
      {name: 'micro-app', href: 'https://micro-zoe.github.io/micro-app/', icon: './images/favicons/micro-app.ico', title: '微前端解决方案'},
    ],
    "3D": [
      {name: 'webgl中文网', href: 'http://www.hewebgl.com/', icon: './images/favicons/webgl中文网.ico', title: '用于web3D'},
      {name: 'Three.js', href: 'http://www.webgl3d.cn/', icon: './images/favicons/Three.js.ico', title: '3d框架'},
      {name: 'CesiumGS', href: 'https://github.com/CesiumGS/cesium', icon: './images/favicons/github.png', title: '3d框架'},
    ],
    "移动端": [
      {name: 'uView UI', href: 'https://www.uviewui.com/', icon: './images/favicons/uView UI.png', title: '全面兼容nvue的uni-app生态框架，全面的组件和便捷的工具会让您信手拈来，如鱼得水'},
      {name: 'Frozen', href: 'http://frozenui.github.io/', icon: './images/favicons/Frozen.ico', title: '移动端ui组件库'},
    ],
    "一些插件": [
      {name: 'vscode插件', href: 'https://marketplace.visualstudio.com/', icon: './images/favicons/vscode插件.ico', title: 'vscode插件'},
      {name: 'nprogress', href: 'https://madewith.cn/23', icon: './images/favicons/nprogress.png', title: '加载进度条'},
      {name: 'plupload文件上传插件', href: 'https://www.plupload.com/', icon: './images/favicons/plupload文件上传插件.ico', title: '文件上传插件'},
      {name: 'Aplayer', href: 'https://aplayer.js.org/#/', icon: '', title: '音乐播放插件'},
      {name: 'MetingJS', href: 'https://github.com/metowolf/MetingJS', icon: './images/favicons/github.png', title: '音乐播放插件的附件'},
      {name: 'swiper', href: 'https://www.swiper.com.cn/', icon: './images/favicons/swiper.ico', title: '轮播图插件'},
      {name: 'Aliplayer', href: 'https://player.alicdn.com/aliplayer/index.html', icon: './images/favicons/Aliplayer.ico', title: '视频播放插件'},
      {name: '西瓜播放器', href: 'https://v2.h5player.bytedance.com/', icon: './images/favicons/西瓜播放器.ico', title: '视频播放插件'},
      {name: 'editormd', href: 'https://pandao.github.io/editor.md/', icon: './images/favicons/editormd.ico', title: '富文本编辑器插件'},
      {name: 'tinymce富文本编辑器', href: 'http://tinymce.ax-z.cn/', icon: '', title: '富文本编辑器插件，上传图片可以转base64'},
      {name: 'Quill富文本编辑器', href: 'https://www.kancloud.cn/liuwave/quill/1409423', icon: './images/favicons/Quill富文本编辑器.ico', title: '富文本编辑器插件'},
      {name: 'froala富文本编辑器', href: 'https://froala.com/wysiwyg-editor/', icon: './images/favicons/froala富文本编辑器.png', title: '比较美观的一款富文本编辑器插件'},
      {name: 'ckeditor富文本编辑器', href: 'https://ckeditor.com/', icon: './images/favicons/ckeditor富文本编辑器.png', title: '富文本编辑器插件'},
      {name: 'tiptap富文本编辑器', href: 'https://tiptap.dev/', icon: './images/favicons/tiptap富文本编辑器.svg', title: '富文本编辑器插件'},
    ...
    "微信公众号": [
      ...
      {name: '微信公众号平台', href: 'https://mp.weixin.qq.com/', icon: './images/favicons/微信.ico', title: ''},
    ],
    "UI设计灵感": [
      {name: 'Behance', href: 'https://www.behance.net/', icon: './images/favicons/Behance.ico', title: '全球最大的综合性设计网站之一'},
      {name: 'UICN用户体验设计平台', href: 'https://www.ui.cn/', icon: './images/favicons/UICN用户体验设计平台.ico', title: '国内最大UI设计交流平台之一'},
      {name: 'dribbble', href: 'https://dribbble.com/pachytel', icon: './images/favicons/dribbble.ico', title: '非常不错的一个UI平台，就是国外的有点慢'},
      {name: '81-web', href: 'https://81-web.com/', icon: './images/favicons/81-web.ico', title: '一款日本的webUI设计平台'},
      {name: 'muuuuu', href: 'https://muuuuu.org/', icon: './images/favicons/muuuuu.ico', title: '一款日本的webUI设计平台'},
      {name: 'webdesignclip', href: 'https://webdesignclip.com/', icon: './images/favicons/webdesignclip.ico', title: '日本酷站画廊'},
      {name: 'Awwwards', href: 'http://bm.straightline.jp/', icon: './images/favicons/Awwwards.ico', title: '最佳网页设计趋势（日本平台）'},
      {name: 'Reeoo', href: 'https://reeoo.com/', icon: './images/favicons/Reeoo.ico', title: '网页设计灵感和网站画廊'},
      {name: 'SiteSee ', href: 'https://sitesee.co/', icon: './images/favicons/SiteSee.ico', title: '收录漂亮的界面设计网站'},
    ],
    "素材": [
      {name: '阿里巴巴矢量图标库', href: 'https://www.iconfont.cn/', icon: './images/favicons/阿里巴巴矢量图标库.svg', title: '我心中最好的字体图标网站'},
      {name: 'Icônes', href: 'https://icones.js.org/', icon: './images/favicons/Icônes.svg', title: '免费图标、logo'},
      {name: 'Icon Sets • Iconify', href: 'https://icon-sets.iconify.design/', icon: './images/favicons/Iconify.png', title: '免费图标、logo'},
      {name: 'dafont', href: 'https://www.dafont.com/', icon: './images/favicons/dafont.ico', title: '免费字体'},
      {name: 'webfont-generator', href: 'https://www.fontsquirrel.com/tools/webfont-generator', icon: './images/favicons/webfont-generator.png', title: '将ttf字体转为其他html可用的字体'},
      {name: 'Font Awesome', href: 'http://www.fontawesome.com.cn/', icon: './images/favicons/Font Awesome.ico', title: 'mavoneditor用的这一款,比较不错'},
      {name: 'heroicons', href: 'https://heroicons.com/', icon: './images/favicons/heroicons.png', title: '一款字体图标库'},
      {name: 'fontspace', href: 'https://www.fontspace.com/', icon: './images/favicons/fontspace字体.webp', title: '一款字体图标库'},
      {name: 'undraw', href: 'https://undraw.co/illustrations', icon: './images/favicons/undraw.ico', title: '免费可商用自定义颜色图表图标库'},
      {name: 'heropatterns', href: 'https://heropatterns.com/', icon: '', title: '一些背景文案'},
      {name: '站酷', href: 'https://www.zcool.com.cn/', icon: './images/favicons/站酷.ico', title: '素材及UI设计网站'},
      {name: '站长素材', href: 'https://sc.chinaz.com/', icon: './images/favicons/站长素材.ICO', title: '各种素材'},
      {name: '花瓣网', href: 'https://huaban.com/', icon: './images/favicons/花瓣网.png', title: '素材及UI设计网站'},
      {name: '平面设计师素材网', href: 'https://www.1001freedownloads.com/', icon: './images/favicons/平面设计师素材网.ico'},
      {name: '懒人包PNG素材网', href: 'https://www.stickpng.com/', icon: './images/favicons/懒人包PNG素材网.ico'},
      {name: '免费商用高清图库', href: 'https://unsplash.com/', icon: './images/favicons/免费商用高清图库.png'},
      {name: '免费商用PSD设计图', href: 'https://www.freepik.com/', icon: './images/favicons/免费商用PSD设计图.ico'},
    ...
    "常用工具": [
      ...
      {name: '比特虫', href: 'https://www.bitbug.net/', icon: './images/favicons/比特虫.ico', title: '图标ico生成工具'},
      {name: '微图', href: 'https://devtool.tech/tiny-image', icon: './images/favicons/开发者武器库.svg', title: '可以将png、jpg格式图片压缩成webp格式'},
      {name: '路过图床', href: 'https://imgtu.com/', icon: './images/favicons/路过图床.png', title: '可以存储图片在线引用'},
      {name: '聚合图床', href: 'https://www.superbed.cn/', icon: './images/favicons/聚合图床.ico', title: '可以存储图片在线引用'},
      {name: '开发者武器库', href: 'https://devtool.tech/', icon: './images/favicons/开发者武器库.svg', title: '包含微图等多种开发工具'},
      {name: 'carbon生成图片', href: 'https://carbon.now.sh/', icon: './images/favicons/carbon生成图片.ico', title: '可以生成代码背景的图片'},
      {name: '在线PS', href: 'https://www.gaituya.com/ps/', icon: './images/favicons/在线PS.ico'},
      {name: '智能抠图', href: 'https://www.isheji.com/cutout/workbench?img_id=60c9b7284a9a3', icon: './images/favicons/智能抠图.ico'},
    ...
    "取色": [
      ...
      {name: 'gradihunt', href: 'https://gradihunt.com/', icon: './images/favicons/gradihunt.png', title: '渐变色'},
      {name: 'gradients', href: 'https://webgradients.com/?ref=iamxk', icon: './images/favicons/gradients.png', title: '渐变色'},
      {name: 'grabient', href: 'https://www.grabient.com/', icon: './images/favicons/grabient.ico', title: '渐变色'},
      {name: 'html取色器', href: 'https://c.runoob.com/front-end/5449/', icon: './images/favicons/html取色器.ico', title: '菜鸟工具里的取色器'},
      {name: '中国色', href: 'http://zhongguose.com/', icon: './images/favicons/中国色.ico', title: '中国传统颜色取色'},
      {name: 'Color Hunt', href: 'https://www.colorhunt.co/', icon: './images/favicons/Color Hunt.svg', title: '一款不错的颜色搭配取色'},
      {name: 'Adobe Color', href: 'https://color.adobe.com/zh/create/color-wheel', icon: './images/favicons/Adobe Color.ico', title: '权威的色彩网站之一'},
      {name: 'WEBSAFECOLORS', href: 'https://www.bootcss.com/p/websafecolors/', icon: '', title: 'web安全色 '},
    ],
    "代码生成的一些样式": [
      {name: 'Variant Form', href: 'https://www.vform666.com/', icon: './images/favicons/Variant Form.ico', title: '地代码表单生成平台'},
      {name: 'CodeFun', href: 'https://code.fun/', icon: './images/favicons/CodeFun.ico', title: '代码生成平台，外包神器'},
      {name: 'creative-backgrounds', href: 'https://wweb.dev/resources/creative-backgrounds/', icon: './images/favicons/wweb.ico', title: '文案背景'},
      {name: 'getwaves', href: 'https://getwaves.io/', icon: './images/favicons/getwaves.png', title: '获取波浪效果的svg'},
      {name: 'creative-hover-effects', href: 'https://wweb.dev/resources/creative-hover-effects/', icon: './images/favicons/wweb.ico', title: '鼠标悬浮效果'},
      {name: 'css-separator-generator', href: 'https://wweb.dev/resources/css-separator-generator/', icon: './images/favicons/wweb.ico', title: '各种分割效果'},
      {name: 'fancy-border-radius', href: 'https://9elements.github.io/fancy-border-radius/', icon: './images/favicons/fancy-border-radius.png', title: '特殊圆角'},
      {name: 'navnav', href: 'http://navnav.co/', icon: './images/favicons/navnav.png', title: '各种特效现成的代码'},
      {name: 'hype4', href: 'https://hype4.academy/tools', icon: './images/favicons/hype4.png', title: '包含css卡片生成器等'},
    ],
    "杂项": [
      {name: '猫云', href: 'https://www.bootcdn.cn/', icon: './images/favicons/猫云.ico', title: '各种文件的cdn'},
      {name: 'npm', href: 'https://www.npmjs.com/', icon: './images/favicons/npm.png', title: 'npm能下载的所有内容的文档'},
      {name: 'fastclick', href: 'https://github.com/ftlabs/fastclick', icon: './images/favicons/github.png', title: '一个用于优化的东西，不知道干啥的了'},
      {name: 'pyscript', href: 'https://pyscript.net/', icon: './images/favicons/pyscript.ico', title: '可以用html写python代码'},
    ],
  },
  "后端开发": {
    "工具": [

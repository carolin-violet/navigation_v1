...
const navList = {
  "学习": {
    ...
    "梯子": [
      {name: '接码平台', href: 'https://sms-activate.org/', icon: '../images/favicons/牛客网.ico', title: '虚拟电话号码购买'},
      {name: '斗罗云', href: 'https://www.douluoyun.lol/', icon: '../images/favicons/牛客网.ico'},
      {name: '桔子云', href: 'https://juzi90.com/user#', icon: '../images/favicons/牛客网.ico'},
      {name: '祢豆子', href: 'https://nezuko.cc/user', icon: '../images/favicons/牛客网.ico'},
      {name: '萝莉云', href: 'https://xn--9kq340kxma.com/#/dashboard', icon: '../images/favicons/牛客网.ico'},
      {name: '炭炭云', href: 'https://tantanyun.xyz/#/dashboard', icon: '../images/favicons/牛客网.ico'},
      {name: '优云', href: 'https://youyun222.com/user', icon: '../images/favicons/牛客网.ico'},
      {name: 'JAFI', href: 'https://www.jafiyun.space/user', icon: '../images/favicons/牛客网.ico'},
      {name: 'STC-SERVER', href: 'https://pwjmtniso4.stcserver-cloud.com/user', icon: '../images/favicons/牛客网.ico'},
    ],
    "外包接单": [
